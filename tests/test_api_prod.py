#!/usr/bin/env python3
"""
Comprehensive test script untuk Stunting Checking App API - Production Environment
"""
...
BASE_URL = "https://stunting-api.dedan.my.id/api"
...
def test_root():
    ...
    try:
        response = requests.get("https://stunting-api.dedan.my.id/")
        if response.status_code == 200:
...
def main():
    """Main test function"""
    print("🧪 Comprehensive Testing Stunting Checking App API - Production")
    print("=" * 70)
